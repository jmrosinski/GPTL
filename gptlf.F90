...
! User-accessible integers 
  ...
  ! This nasty wart is needed until there is a standard way to determine cores per SM
#ifdef HOMEPC
  integer, parameter :: GPTLcores_per_sm = 128
  integer, parameter :: GPTLcores_per_gpu = 640
#else
  integer, parameter :: GPTLcores_per_sm = 64
  integer, parameter :: GPTLcores_per_gpu = 3584
#endif
  ...
  integer, parameter :: GPTLmaxwarps_gpu   = 52
...
! Function prototypes
  ...
  interface
     ...
     integer function gptlcompute_chunksize (oversub, inner_iter_count)
