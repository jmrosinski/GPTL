...
#JR copied from https://raw.githubusercontent.com/Macaulay2/M2/master/M2/config/openmp.m4
#JR Get further on Apple clang but still causes problems building the tests
